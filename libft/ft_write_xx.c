...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/03/23 18:03:33 by fschille          #+#    #+#             */
/*   Updated: 2019/03/23 18:03:35 by fschille         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_print_xx_check(char **x, t_arg **flag, int *ret)
{
...
void	ft_print_xx_check2(char **x, t_arg **flag, int *ret)
{
...
int		ft_print_xx(char *x, t_arg *flag)
{
	...
	{
		ft_print_xx_check(&x, &flag, &ret);
		ft_print_xx_check2(&x, &flag, &ret);
	}
	free(x);
	free(flag);
	return (ret);
